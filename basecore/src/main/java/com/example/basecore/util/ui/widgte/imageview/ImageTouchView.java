package com.example.basecore.util.ui.widgte.imageview;
...
/**
 * Created by Tangyanjun
 * Date 18-3-15
 * Email 312976625@qq.com
 */
public class ImageTouchView extends android.support.v7.widget.AppCompatImageView{
    ...
    static class RotateGestureDetector {
    ...
    public ImageTouchView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(ImageTouchView.this);
            }
        }
